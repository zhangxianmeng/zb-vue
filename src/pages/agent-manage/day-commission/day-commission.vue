<template>
  <div>
    ...
    <div class="border-content">
      ...
      <div class="search-filter common-filter">
        <p>
          <span>开始时间：</span>
          <el-date-picker
              :clearable="false"
        ...
        <p>
          <el-button @click="searchData" type="primary">提交</el-button>
        </p>
      </div>
...
<script>
  import {dayCommissionModule} from '@/common/js/mixin'
